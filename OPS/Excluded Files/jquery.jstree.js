		...
		_fn : { 
			...
			open_node	: function (obj, callback, skip_animation) {
				...
				if(!this._is_loaded(obj)) {
					...
					if(s) { obj.children("ul").stop(true, true).slideDown(0, function () { this.style.display = ""; t.after_open(obj); }); }
			...
			close_node	: function (obj, skip_animation) {
				...
				if(s) { obj.children("ul").stop(true, true).slideUp(0, function () { this.style.display = ""; t.after_close(obj); }); }
