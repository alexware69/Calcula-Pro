            ...
            switch (name)
            {
                case "floor":
                    if (args.Length == 1)
                    {
                        ...
                        result.m_value = System.Math.Floor(((Symbol)args[0]).m_value);
                    }
                    else
                    {
                ...
                case "ceiling":
                    ...
                    {
                        result.m_name = name + "(" + ((Symbol)args[0]).m_value.ToString() + ")";
                        result.m_value = System.Math.Ceiling(((Symbol)args[0]).m_value);
                    }
                    else
                    {
                        result.m_name = "Invalid number of parameters in: " + name + ".";
                ...
                case "round":
                    ...
                    {
                        result.m_name = name + "(" + ((Symbol)args[0]).m_value.ToString() + ")";
                        result.m_value = System.Math.Round(((Symbol)args[0]).m_value, 0);
                    }
                    else
                    {
                        result.m_name = "Invalid number of parameters in: " + name + ".";
                ...
                case "trunc":
                    ...
                    {
                        result.m_name = name + "(" + ((Symbol)args[0]).m_value.ToString() + ")";
                        result.m_value = System.Math.Truncate(((Symbol)args[0]).m_value);
                    }
                    else
                    {
                        result.m_name = "Invalid number of parameters in: " + name + ".";
